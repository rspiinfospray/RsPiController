...
public class AutoPiloteOnAsyncUI extends AsyncTask<Void, Integer, Boolean> {
	...
	public AutoPiloteOnAsyncUI(ControllerActivity activity) {
		super();
	...
	protected Boolean doInBackground(Void... params) {
		...
		return CommonCallWs.callAutoPiloteOnWs();
	}
