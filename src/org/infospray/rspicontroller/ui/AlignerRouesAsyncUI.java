...
public class AlignerRouesAsyncUI extends AsyncTask<Void, Integer, Boolean> {
	...
	public AlignerRouesAsyncUI(ControllerActivity activity) {
		super();
	...
	protected Boolean doInBackground(Void... params) {
		...
		return CommonCallWs.callAlignerRouesWs();
	}
